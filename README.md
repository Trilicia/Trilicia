...
- 📊 Análise, tratamento e interpretação de dados
- 📈 Business Intelligence, KPIs e Data Visualization
- 🐍 Python, SQL, Pandas e automação de análises
- 🤖 Machine Learning e Inteligência Artificial aplicada
- 📐 Estatística descritiva, inferencial e multivariada
- 📋 Gestão de projetos, processos e melhoria contínua
- 👥 Liderança e comunicação com stakeholders
- 🎯 Tomada de decisão orientada por dados

## Tecnologias e ferramentas

**Análise de dados:** Python, Pandas, NumPy e Excel  
**Banco de dados:** SQL, SQLite e PostgreSQL  
**Visualização:** Power BI, Looker Studio, Matplotlib e Seaborn  
**Machine Learning:** Scikit-learn  
**Big Data:** PySpark  
**Inteligência Artificial:** Microsoft Azure AI  
**Desenvolvimento:** HTML, CSS e JavaScript  
**Versionamento:** Git, GitHub e GitHub Desktop  
...
Conheça meus projetos, dashboards e estudos de caso:

🌐 [Acessar meu portfólio profissional](https://trilicia.github.io/Portfolio/)

## Contato

💼 [LinkedIn](https://www.linkedin.com/in/trilicia-gomes-8606451a7/)  
💻 [GitHub](https://github.com/Trilicia)

---

Estou aberta a oportunidades em **Análise de Dados, Business Intelligence e Gestão de Projetos em Dados e IA**.
